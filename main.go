...
var (
	...
	activityTimeout = flag.Int("activity-timeout", 180, "Activity timeout in seconds (how long to wait before marking as inactive)")
	checkInterval   = flag.Int("check-interval", 90, "Activity check interval in seconds (how often to check activity status)")
